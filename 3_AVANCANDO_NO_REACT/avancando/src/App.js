...
function App() {
  ...
  const users = [ 
    {id:1 ,nome: "Ruan",idade:35,profissao:"Programador"},
    {id:2 ,nome: "Romario",idade:65,profissao:"Vigilante"},
    {id:3, nome: "Daniel",idade:45,profissao:"Digitador"},
    {id:4, nome: "Priscila",idade:16,profissao:"Estudante"}
  ];
